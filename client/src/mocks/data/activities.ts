...
export const mockActivities: ActivityRecordWithIdServer[] = [
  ...
  { id: "5", date: generateDate(2), name: "Running", categoryId: "cat-sports" },
  { id: "6", date: generateDate(3), name: "Cycling", categoryId: "cat-sports" },
  { id: "7", date: generateDate(3), name: "Yoga", categoryId: "cat-wellness" },
  { id: "8", date: generateDate(4), name: "Running", categoryId: "cat-sports" },
  {
    id: "9",
    date: generateDate(4),
    name: "Reading",
  ...
  { id: "14", date: generateDate(7), name: "Yoga", categoryId: "cat-wellness" },
  {
    id: "15",
    date: generateDate(7),
    name: "Reading",
